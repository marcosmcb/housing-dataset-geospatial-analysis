...
```{r Box-Plot of Town or Neighbourhood and House price, fig.height=15, fig.width=15, message=FALSE, warning=TRUE}
...
```{r Plot of Count of Houses by County, warning=FALSE, message=FALSE, fig.height=15, fig.width=15}
