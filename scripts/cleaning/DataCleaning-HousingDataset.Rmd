...
As the _ber_code_ variable only represents the certificate number of the BER rating (Building Energy Rating), we can safely remove this column from the dataset as the certificate number will be individually assigned to each property and do not actually influence on the house price, instead the house's BER rating and BER EPI (Energy Performance Indicator) are what in fact affect the house price.
